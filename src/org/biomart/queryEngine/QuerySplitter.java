...
public final class QuerySplitter {
    ...
    public void disectQuery() throws FunctionalException {
        ...
        for (QueryElement queryElement : this.queryElementList) {
            if (queryElement.getType() != QueryElementType.FILTER && queryElement.isPointer()) {
                this.addToQuery(queryElement);
            }
        }
        for (QueryElement queryElement : this.queryElementList) {
     ...
     * @param queryElement
     */
    public void addToQuery(QueryElement queryElement) throws FunctionalException {
        ...
        if (queryElement.isPointer()) {
            ...
            if (queryElement.getType() == QueryElementType.ATTRIBUTE) {
                ...
                this.addToQuery(new QueryElement(((Attribute) queryElement.getElement()).getPointedAttribute(), pointedDataset));
