...
public class JobPlan implements Serializable {
	...
	public static class JobPlanSection implements Serializable {
		...
		private void updateEnded(Date newEnded, final Collection<JobPlanAction> allActions) {
		...
		private void updateStarted(Date newStarted, final Collection<JobPlanAction> allActions) {
			// If our date is not null and new date is not null
