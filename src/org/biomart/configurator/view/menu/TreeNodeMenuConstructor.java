...
public class TreeNodeMenuConstructor implements ActionListener {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (e.getActionCommand().equals("createImportables")) {
			if (nodeHandler.requestCreateElementList(node,
					PortableType.IMPORTABLE))
				((DefaultTreeModel) ltree.getModel())
						.nodeStructureChanged(node);
		} else if (e.getActionCommand().equals("createExportables")) {
			if (nodeHandler.requestCreateElementList(node,
					PortableType.EXPORTABLE))
				((DefaultTreeModel) ltree.getModel())
						.nodeStructureChanged(node);
		...
		} else if (e.getActionCommand().equals("updateRelation")) {
			if (node.updateTargetRelations())
				((DefaultTreeModel) ltree.getModel())
						.nodeStructureChanged(node);
