...
class MsSQLDialect extends DatabaseDialect {
	...
	protected String quote(String value) {	// overriden by mysql and mssql
		return MSSQL_OPEN_QUOTE + value + MSSQL_CLOSE_QUOTE;
	}
	@Override
	...
	protected final String addRenameStatement(final String schemaName, final String oldTableName, final String newTableName) {
		return EXEC + " " + SP_RENAME + " " + quote(schemaName + "." + oldTableName) + ", " + quote(newTableName);
	}
	...
	@Override
	protected final String addComputedTableSuffix(final String newTableName) {
		return " " + INTO + " " + newTableName;
	}
	@Override
	...
	@Override
	protected final String addIndexPrefix(final String schemaName) {
		return "";
	}
}