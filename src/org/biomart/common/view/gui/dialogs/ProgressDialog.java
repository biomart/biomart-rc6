			...
			public void actionPerformed(final ActionEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {						
						...
						if (ProgressDialogFactory.this.isVisible()) {
							ProgressDialogFactory.this.statusLabel.setText(ProgressDialogFactory.this.statusMessage);
							ProgressDialogFactory.this.pack();
						}
						else {
